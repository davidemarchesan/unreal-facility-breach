...
void FFacilityBreachStyle::InitializeBrushes()
{
	...
	StyleInstance->Set("Brush.Goal.ProgressBar.InProgress", new FSlateRoundedBoxBrush(FLinearColor::Yellow, 4.f));
	StyleInstance->Set("Brush.Goal.ProgressBar.Completed", new FSlateRoundedBoxBrush(FLinearColor::White, 4.f));
